...
export default function Project() {
    return  (
        ...
        <About subheading="Data Mining" text='Data sets used were a shapefile that contains all counties in alabama, temperature and precipitation csv files. Shape files 
        ...
        <About subheading="Data Cleaning and Coding" text='Temperature and Precipitation data are saved in a CSV format. To clean the data I used the pandas library. Data in the CSV file had the year, month and value as 200007,149, 3 rows to be deleted, the last row was
        ...
        '/>
        <About subheading="Data Visualizations" text='To create the visualizations I used geopandas and matplotlib. create_row_merge
