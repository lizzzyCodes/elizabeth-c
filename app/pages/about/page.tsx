...
export default function About() {
  ...
  <section about="about me container">
    ...
    <div about='text' className='font-["montserrat"] text-[20px] text-white'>
      ...
      <br /> I have over a year of full-time software engineering experience, with a background in Data Science, and a passion for front end development. I was born and raised in Des Moines, Washington. (40 min from Seattle) and I am currently based in Chicago.
      <br /> Outside work, I spend most of my time mentoring students on various aspects of their academic journeys, including mock interviews for selective programs, college applications and reinforcing computer science topics.
      <br /> As the first in my family to graduate from college and having attended a school with capacity-constrained majors (academic programs that have limited enrollment capacity) my university journey began with the disheartening advice from advisors who discouraged me from applying to computer science.
